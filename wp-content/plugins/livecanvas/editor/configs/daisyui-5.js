...
let theBlocks = {
	...
	"Video / Media / Embed": {
		...
		blocks: [
			...
			},
			{
				...
				template_html: `
				<figure class="w-full overflow-hidden rounded shadow-xl">
	...
	"Badges": {
		...
		blocks: [
			...
			{
				name: "Badge with soft style",
				icon_html: `<i aria-hidden="true" class="fa fa-sliders"></i>`,
				template_html: `
				<div class="flex flex-wrap gap-2">
					<span class="badge badge-primary badge-soft">Primary</span>
					<span class="badge badge-secondary badge-soft">Secondary</span>
					<span class="badge badge-accent badge-soft">Accent</span>
					<span class="badge badge-neutral badge-soft">Neutral</span>
					<span class="badge badge-info badge-soft">Info</span>
					<span class="badge badge-success badge-soft">Success</span>
					<span class="badge badge-warning badge-soft">Warning</span>
			...
			{
				name: "Badge with dash style",
				icon_html: `<i aria-hidden="true" class="fa fa-ellipsis-h"></i>`,
				template_html: `
				<div class="flex flex-wrap gap-2">
					<span class="badge badge-dash">Default</span>
					<span class="badge badge-dash badge-primary">Primary</span>
					<span class="badge badge-dash badge-secondary">Secondary</span>
					<span class="badge badge-dash badge-accent">Accent</span>
					<span class="badge badge-dash badge-neutral">Neutral</span>
					<span class="badge badge-dash badge-info">Info</span>
					<span class="badge badge-dash badge-success">Success</span>
					<span class="badge badge-dash badge-warning">Warning</span>
					<span class="badge badge-dash badge-error">Error</span>
				</div>
			`
			},

			{
				...
				template_html: `
				<div class="flex flex-wrap gap-2">
					<span class="badge badge-neutral badge-outline">Neutral outline</span>
					<span class="badge badge-neutral badge-dash">Neutral dash</span>
				</div>
			`
			},
